...
function ticketMarkup({ event, sale, ticket, qrCode, design, index, count, showCutGuide }) {
  ...
  const generationOrigin = `<p class="generation-origin">${html(ticket.generatedByName || "Usuário não identificado")} | ${html(ticket.generatedAtText || "Data e hora não registradas")}</p>`;
