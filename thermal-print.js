...
function ticketMarkup({ event, sale, ticket, qrCode, design, index, count, showCutGuide }) {
  ...
  const cutGuide = showCutGuide ? `<div class="cut-guide" aria-label="Linha de corte"><span aria-hidden="true">✂</span></div>` : "";
