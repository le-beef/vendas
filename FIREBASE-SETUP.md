# Configuração de segurança e financeiro — Le Beef 3.11.1

Os eventos e participantes já cadastrados não serão apagados.

## 1. Publicar o site e marcar os eventos

1. Publique os arquivos da versão 3.11.1 no GitHub Pages.
...
O histórico registra ações realizadas depois da publicação das regras da versão 3.4.0. Na versão 3.11.1, o cartão recolhido dos participantes foi compactado em duas linhas no celular. A estrutura do Firebase e o funcionamento das cortesias permanecem inalterados.
