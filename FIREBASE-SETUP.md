# Configuração de segurança e financeiro — Le Beef 3.11.0

Os eventos e participantes já cadastrados não serão apagados.

## 1. Publicar o site e marcar os eventos

1. Publique os arquivos da versão 3.11.0 no GitHub Pages.
...
O histórico registra ações realizadas depois da publicação das regras da versão 3.4.0. Na versão 3.11.0, eventos também podem guardar cortesias compostas pelos ingressos cadastrados. Cada cortesia lançada reduz o estoque dos tipos individuais correspondentes, sem gerar valor financeiro. A estrutura permanece compatível com eventos e vendas anteriores.
