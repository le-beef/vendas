# Configuração de segurança e financeiro — Le Beef 3.12.2

Os eventos e participantes já cadastrados não serão apagados.

## 1. Publicar o site e marcar os eventos

1. Publique os arquivos da versão 3.12.2 no GitHub Pages.
...
O histórico registra ações realizadas depois da publicação das regras da versão 3.4.0. Na versão 3.12.2, o indicador visual do menu foi simplificado para **Conectado** ou **Desconectado**. A estrutura do Firebase e o funcionamento das cortesias permanecem inalterados.
