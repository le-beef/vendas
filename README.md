...
A versão 4.5.3 restaura o download do Excel das reservas no celular, mantendo o botão abaixo da busca e ocupando toda a largura disponível.
...
Na atualização para a versão 4.5.3, envie todos os arquivos do pacote ao GitHub Pages. Eventos e vendas antigas continuam disponíveis normalmente; esta versão não exige alteração nas regras do banco de dados.
