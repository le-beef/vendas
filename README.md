...
A versão 3.3.1 usa contas individuais com e-mail e senha e traz o novo ícone oficial da Le Beef no navegador e no aplicativo instalado.
...
Na atualização para a versão 3.3.1, envie primeiro os arquivos ao GitHub Pages, entre como administrador e marque os eventos permitidos. Em seguida, publique o conteúdo de `database.rules.json` em **Realtime Database > Rules**.
