...
A versão 4.1.1 aprimora o modo de **mesas/bistrôs + vendas unitárias**. O administrador escolhe Salão, Mezanino ou ambos e ativa posições predefinidas sobre os mapas oficiais, definindo cada posição como mesa ou bistrô. A numeração é única e contínua entre tipos e áreas. Esta correção também ajusta a abertura, a rolagem e os toques no mapa pelo celular.
