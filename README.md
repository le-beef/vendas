...
A versão 3.3.6 usa contas individuais com e-mail e senha, traz o ícone oficial da Le Beef, melhora a leitura dos participantes no celular e destaca o cabeçalho da área de participantes com o degradê visual do evento.
...
Na atualização para a versão 3.3.6, envie primeiro os arquivos ao GitHub Pages, entre como administrador e marque os eventos permitidos. Em seguida, publique o conteúdo de `database.rules.json` em **Realtime Database > Rules**.
